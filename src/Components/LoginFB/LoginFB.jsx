        ...
        <div className={styles.form_container}>
          <form onSubmit={handleSubmit(onSubmit)} className={styles.formulario}>
            <fieldset className={styles.formulario__fieldset}>
              <legend className={styles.formulario__legend}>
                <h1>Enter your User</h1>
              </legend>
              <div className={styles.formulario__contenedorCampos}>
                <div className={styles.formulario__contenedorCampos__campo}>
                  ...
                  {errors.email?.type === "required" && (
                    <p className={styles.leyenda}>Email is required</p>
                  )}
                  {errors.email?.type === "pattern" && (
                    <p className={styles.leyenda}>Email is invalid</p>
                  )}
                  {errors.email?.type === "maxLength" && (
                    <p className={styles.leyenda}>Email is too long</p>
                  )}
                </div>
                ...
                <div className={styles.formulario__contenedorCampos__campo}>
                  ...
                  {errors.password?.type === "required" && (
                    <p className={styles.leyenda}>Password is required</p>
                  )}
                  {errors.password?.type === "pattern" && (
                    <p className={styles.leyenda}>
                      Password must have at least one number, one lowercase and
              ...
              <div className={styles.contenedorBotones}>
                <button
                  type="submit"
                  className={styles.contenedorBotones__boton}
                >
                  Log In
                </button>
